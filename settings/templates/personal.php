...
<div class="section">
	...
	<span><?php if(!empty($_['displayName'])) { p($_['displayName']); } else { p($l->t('No display name set')); } ?></span>
</div>
<?php
}
?>
...
<div class="section">
	...
	<span><?php if(!empty($_['email'])) { p($_['email']); } else { p($l->t('No email address set')); }?></span>
</div>
<?php
}
?>
